...
/**
 * Modal Component for rendering documentation about the plotting scene
 * 
 * @param  - onClose React Prop callback function for determining onClose state and actions  

...
export async function seed(knex: Knex): Promise<void> {
  ...
  const superRole    = await knex('role_rol').where('name_rol', 'superuser').first();
  ...
  await knex('input_channel_inc').insert([
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 1,  instrument_name_inc: 'Kick Drum',    mic_type_inc: 'Beta 52A',            notes_inc: 'Gate at -20dB' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 2,  instrument_name_inc: 'Snare Top',    mic_type_inc: 'SM57' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 3,  instrument_name_inc: 'Snare Bottom', mic_type_inc: 'SM57' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 4,  instrument_name_inc: 'Hi-Hat',       mic_type_inc: 'SM81' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 5,  instrument_name_inc: 'Rack Tom 1',   mic_type_inc: 'Sennheiser MD421' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 6,  instrument_name_inc: 'Rack Tom 2',   mic_type_inc: 'Sennheiser MD421' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 7,  instrument_name_inc: 'Floor Tom',    mic_type_inc: 'Sennheiser MD421' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 8,  instrument_name_inc: 'Overhead L',   mic_type_inc: 'AKG C414' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 9,  instrument_name_inc: 'Overhead R',   mic_type_inc: 'AKG C414' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 10, instrument_name_inc: 'Bass DI',      mic_type_inc: 'Countryman Type 85' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 11, instrument_name_inc: 'Bass Amp',     mic_type_inc: 'Sennheiser e906' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 12, instrument_name_inc: 'Guitar 1',     mic_type_inc: 'SM57' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 13, instrument_name_inc: 'Guitar 2',     mic_type_inc: 'SM57' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 14, instrument_name_inc: 'Keyboard L',   mic_type_inc: 'Direct' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 15, instrument_name_inc: 'Keyboard R',   mic_type_inc: 'Direct' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 16, instrument_name_inc: 'Lead Vocal',   mic_type_inc: 'Beta 58A',            notes_inc: 'Compression 4:1, reverb' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 17, instrument_name_inc: 'BG Vocal 1',   mic_type_inc: 'SM58' },
    { id_stp_inc: stagePlot1.id_stp, channel_number_inc: 18, instrument_name_inc: 'BG Vocal 2',   mic_type_inc: 'SM58' },
  ]);
